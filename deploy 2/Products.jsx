...
const PRODUCTS = [
{
  ...
  copy: 'Durable, targeted cooling for manufacturing, warehouses, facilities, offices, hospitality, healthcare, events, and operational backup. Move it where the heat is.',
  Render: RenderAC,
  specs: [
