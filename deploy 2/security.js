...
(function () {
  ...
  try {
    ...
    try { sameOrigin = !!(window.top && window.top.location && window.top.location.host === window.location.host); } catch (e) { sameOrigin = false; }
    if (window.self !== window.top && !sameOrigin && /klimaoptima\.com$/i.test(location.hostname)) {
