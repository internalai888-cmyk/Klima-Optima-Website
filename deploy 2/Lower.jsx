    ...
    <section style={koLowerStyles.clients} className="ko-clients">
      ...
      <div style={{position:'relative', maxWidth: 1480, margin:'0 auto'}}>
        <div style={{textAlign:'center'}}>
          ...
          <p style={koLowerStyles.sub}>Climate control trusted by leaders across healthcare, hospitality, construction, commercial spaces, manufacturing, and critical environments. *Partial List</p>
        </div>
