  ...
  <section style={koSecStyles.solutions}>
    ...
    <div style={koSecStyles.centered}>
      ...
      <div style={koSecStyles.cardGrid}>
        ...
        <SolutionCard iconName="gauge" title="Precision Climate Control" copy="Accurate temperature and humidity management for critical environments requiring stable operating conditions." href="precision-climate-control.html"/>
      </div>
    </div>
  </section>
);
