...
const koHeaderStyles = {
  ...
  nav: { display: 'flex', alignItems: 'center', gap: 44, fontFamily: 'var(--ko-font-display)', fontWeight: 600, fontSize: 15, letterSpacing: '0.01em' },
  langPicker: {
...
<div style={{
  ...
  paddingTop: 14
    ...
    overflow: 'hidden'
      ...
      {groups ?
      <div style={{ position: 'relative', display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 18 }}>
        {groups.map((g) =>
